#include "ArchivosProveedor.h"


void ArchivosProveedor::AltaProveedor()
{
	system("cls");
...
void ArchivosProveedor::BajaProveedor()
{
	system("cls");
	Proveedor aux;
	bool borro = false;
...
void ArchivosProveedor::ModificarProveedor()
{
	system("cls");
	Proveedor aux;
	bool modifico = false;
...
void ArchivosProveedor::ListarProveedores()
{
	Proveedor proveedor;
	system("cls");
...
void ArchivosProveedor::BuscarProveedor()
{
	system("cls");
