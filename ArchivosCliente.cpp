#include "ArchivosCliente.h"

void ArchivosCliente::mostrarEncabezado()
{
	cout << left;
	cout << setw(5) << "ID";
	cout << setw(15) << "DNI";
...
void ArchivosCliente::mostrarEncabezado2()
{
	cout << left;
	cout << setw(15) << "DNI";
	cout << setw(20) << "NOMBRES";
...
void ArchivosCliente::AltaCliente()
{
	system("cls");
...
void ArchivosCliente::BajaCliente()
{
	system("cls");
	Cliente aux;
	bool borro = false;
...
void ArchivosCliente::ModificarCliente()
{
...
void ArchivosCliente::ListarClientes()
{
	Cliente cliente;
	system("cls");
...
void ArchivosCliente::BuscarCliente()
{
	system("cls");
